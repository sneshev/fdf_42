...
void	draw_vertical_lines(t_map *map, t_mlxt mlxt)
{
	(void)map;
	(void)mlxt;
}

void	draw_horizontal_lines(t_map *map, t_mlxt mlxt)
{
	(void)map;
	(void)mlxt;
}
...
void	draw_front_view(t_map *map, t_mlxt mlxt)
{
	...
	draw_vertical_lines(map, mlxt);
	draw_horizontal_lines(map, mlxt);
